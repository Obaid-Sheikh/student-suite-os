...
import { CalendarDays, CheckSquare, GraduationCap, ShieldCheck, Sparkles } from "lucide-react";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CampusOS — One workspace for your academic life" },
      {
        ...
        content: "Courses, classwork, calendar and tasks in one organized student workspace.",
      },
    ],
  }),
  component: Landing,
        ...
        <div className="grid flex-1 items-center gap-12 py-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-muted-foreground">
              CampusOS brings your courses, assignments, schedules and academic deadlines into one
              organized workspace — so you stop switching between five different tabs to answer one
              simple question.
            </p>
            ...
            <div className="mt-8 max-w-sm">
              ...
              <p className="mt-3 flex items-start gap-2 text-xs leading-relaxed text-muted-foreground">
                ...
                Connect your school Google account to sync Classroom courses and Calendar events.
                This prototype opens the workspace with sample data — no account is connected yet.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-lift sm:p-8">
            ...
            <div className="mt-7 border-t pt-5">
              <p className="text-sm text-muted-foreground">
                Built for students who want one honest answer to “what do I need to do today?”
              </p>
            </div>
          </div>
        </div>
...
function GoogleGlyph() {
  return (
    <svg viewBox="0 0 24 24" className="h-4.5 w-4.5" aria-hidden>
      ...
      />
      <path fill="#FBBC05" d="M12 22c-4.1 0-7.63-2.35-9.35-5.78l3.3-2.55A6.3 6.3 0 0 0 12 18.3z" />
      <path
        fill="#4285F4"
